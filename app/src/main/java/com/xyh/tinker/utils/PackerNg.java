...
/**
 * 美团渠道打包 ,可java环境 命令执行 和 编译器执行
 * https://www.jianshu.com/p/fe20417337e0
 */
...
//        args = new String[]{"java","-jar"};
        ...
        String my_apk_path = "/Users/xieyuhai/Downloads/androidselfstudy/Tinker/app/build/outputs/apk/release/app-release.apk";
        String market_file = "/Users/xieyuhai/Downloads/androidselfstudy/Tinker/channelpacking/market.txt";

        args = new String[]{my_apk_path, market_file};
